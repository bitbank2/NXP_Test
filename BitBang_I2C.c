...
#endif
#if !defined( __AVR_ATtiny85__ ) && !defined( __MCUXPRESSO)
#include <Wire.h>
#endif
#ifdef W600_EV
...
void I2CInit(BBI2C *pI2C, uint32_t iClock)
{
   ...
   {
#if !defined( _LINUX_ ) && !defined( __AVR_ATtiny85__ ) && !defined( __MCUXPRESSO)
